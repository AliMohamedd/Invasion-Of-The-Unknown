...
namespace IOTU
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "IOTU/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "IOTU/Don't Load Bootstrap Scene On Play";
