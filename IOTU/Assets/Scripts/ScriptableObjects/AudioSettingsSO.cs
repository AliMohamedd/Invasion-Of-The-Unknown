...
namespace IOTU
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "AudioSettings", menuName = "IOTU/AudioSettings", order = 1)]
    public class AudioSettingsSO : DescriptionSO
    {
        ...
        [Tooltip("AudioClip for starting UI")]
        [SerializeField] private AudioClip m_StartingUi;
        [Tooltip("AudioClip for game pLay ")]
        ...
        public AudioClip DoorOpenSound => m_DoorOpenSound;
        public AudioClip DoorCloseSound => m_DoorCloseSound;
        public AudioClip FootStepsSound => m_FootStepsSound;
        ...
        public AudioClip StartingUi => m_StartingUi;
        public AudioClip GamePlay => m_GamePlay;
